...
**触发词**: `需求理解`, `理解需求`, `分析需求`, `需求分析`, `我需要`, `帮我做`, `实现一个`, `开发一个`, `/需求理解`, `@smartflow 需求`
...
**触发词**: `任务拆解`, `拆解任务`, `拆分任务`, `制定计划`, `任务规划`, `怎么实现`, `实现步骤`, `/任务拆解`, `@smartflow 拆解`
...
**触发词**: `方案设计`, `技术方案`, `架构设计`, `设计方案`, `怎么设计`, `数据库设计`, `接口设计`, `API 设计`, `/方案设计`, `@smartflow 设计`
...
**触发词**: `执行实现`, `开始实现`, `写代码`, `编写代码`, `实现功能`, `代码实现`, `开始开发`, `/执行实现`, `@smartflow 实现`
...
**触发词**: `进度跟踪`, `跟踪进度`, `进度更新`, `更新进度`, `项目进展`, `任务状态`, `完成了什么`, `还剩什么`, `/进度跟踪`, `@smartflow 进度`
...
**触发词**: `任务报告`, `生成报告`, `任务总结`, `总结报告`, `完成总结`, `项目总结`, `阶段总结`, `/任务报告`, `@smartflow 报告`
...
**触发词**: `周报`, `生成周报`, `写周报`, `周报生成`, `本周总结`, `周总结`, `weekly report`, `/周报`, `@smartflow 周报`
...
**触发词**: `代码审查`, `code review`, `CR`, `帮我 review`, `帮我看看代码`, `审查代码`, `review 一下`, `代码 review`, `/代码审查`, `@smartflow review`
...
**触发词**: `故障排查`, `debug`, `线上故障`, `报错了`, `排查问题`, `定位 bug`, `为什么报错`, `程序崩溃`, `/故障排查`, `@smartflow debug`
...
**触发词**: `技术调研`, `技术选型`, `POC`, `对比方案`, `选哪个好`, `方案对比`, `调研一下`, `技术评估`, `/技术调研`, `@smartflow 调研`
